...
import { Home, Building2, Users, Lightbulb } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative p-8 md:p-10 bg-white dark:bg-card rounded-2xl border border-border backdrop-blur-sm hover:shadow-xl transition-all duration-300">
